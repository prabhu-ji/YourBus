                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-3 text-right">
                                    @if($item->banner_img != '')
                                    <img id="image" src="{{ asset('banner/' . ($item->banner_img ? $item->banner_img : 'default-banner.jpg')) }}" alt="" width="200px" height="150px">
                                    @else
                                    <img id="image" src="{{asset('/banner/default-banner.jpg')}}" alt="" width="80px" height="80px">
                                    @endif
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="">Button Status</label>
                                <select class="form-control" name="button_status" id="">
                                    <option value="show" {{$item->button_status == "show" ? "selected":""}}>Show</option>
                                    <option value="hide" {{$item->button_status == "hide" ? "selected":""}}>Hide</option>
                                </select>
                            </div>
                        </div>
                        <!-- /.card-body -->
